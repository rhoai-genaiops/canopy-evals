...
<body>
    <div class="container">
        ...
        * {
        ...
        # Generate combined HTML summary for all test results
        def generate_combined_html_summary(all_test_results):
            html_content = []
            
            # Header
            html_content.append(f'<h1>Test Results Summary</h1>')
            html_content.append(f'<p class="summary-info">Found and processed {len(all_test_results)} test configuration(s)</p>')
            
            # Process each test result set
        ...
        html_summary = generate_combined_html_summary(all_test_results)
...
<body>
    <div class="container">
        ...
        print(f"Generated combined HTML summary with {total_tests} total test results")
